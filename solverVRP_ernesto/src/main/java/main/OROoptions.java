...
public class OROoptions {
	...
	private final String INSTANCE_FILE	= "RC207.txt";
	
	private final String CONFIG_ALG_C	= "input/algorithmConfig.xml";
	private final String SOL_PATH_C		= "output/solutions_"+INSTANCE_FILE.substring(0,INSTANCE_FILE.lastIndexOf("."))+".csv";
	...
	public OROoptions(String[] args, String fname,String sol) {
		options = new HashMap<String, String>();
		options.put(INSTANCE_ARG, fname);
		...
		constants.put(CONSTANTS.THREADS, THREADS_C);
		constants.put(CONSTANTS.TIME, TIME_C);
		constants.put(CONSTANTS.OUTPUT, sol);
		constants.put(CONSTANTS.REPETITION, REPETITION_C);
